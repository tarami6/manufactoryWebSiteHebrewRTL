                        ...
                        <div className="OnVideo">
                            ...
                            <div className="ContentHolder08">
                                ...
                                <Element name="test1"  className="SecondContent">
                                    <h2>הזרקת פלסטיק</h2>
                                    <p className="rtlText">
                                        הזרקת פלסטיק, היא טכנולוגיה אשר מטרתה היא ייצור רכיבים או מוצרים שלמים מפלסטיק באמצעות התכתו של חומר הגלם והזרקתו לתבנית שאשר המבנה שלה זהה בצורתו לצורתו של המוצר / הרכיב הסופי. הזרקת פלסטיק, הוא אחד התהליכים הנפוצים ביותר לייצור חלקי פלסטיק.
                                ...
                                <Element name="test2" className="FirstContent">
                                    ...
                                    <p className='rtlText'>עיבוד שבבי, הוא תהליך שבו חומר גלם נחתך לתוך צורה סופית רצויה על ידי הסרץ חומר באופן מבוקר.
                                ...
                                <Element name="test3" className="ThirdContent">
                                    ...
                                    <p className='rtlText'>כבישה היא תהליך שבו אנו בעצם מציבים את המתכת מתחת למכבש. התפקיד של המכבש הוא ליצור לחץ חזק מאד על המתכת, ולשנות את צורתה.
                                        קיימות שתי שיטות מרכזיות לביצוע כבישה - חמה או קרה. כבישה החמה, משתמשים בחימום המתכת לטמפרטורות של מאוד גבוהה גזאת המאפשרת לחומר דינמיות.
