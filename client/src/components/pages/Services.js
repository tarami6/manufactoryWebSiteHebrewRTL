                        ...
                        <div className="OnVideo">
                            ...
                            <div className="ContentHolder08">
                                <div className="FirstContent">
                                    ...
                                    <p className="rtlText">החל מאפיון המוצר , בחירת סוג חומר הגלם , התאמה מרחבית של התבנית  לנפח היצור הנדרש על מנת ליעיל את תהליך היצור ולהוזיל עליות , בנוסף חברתנו מקפידה  על הליך יצור התבנית עצמו  על רמת הדיוק ושימוש בחומר גלם איכותי, כדאי להעריך את חיי התבנית , ולדאוג שרמת אחידות המוצרים תהיה גבוה מאד.  </p>
                                </div>
                                ...
                                <Element name="test3" className="ThirdContent">
                                    ...
                                    <p className='rtlText'>כבישה היא תהליך שבו אנו בעצם מציבים את המתכת מתחת למכבש. התפקיד של המכבש הוא ליצור לחץ חזק מאד על המתכת, ולשנות את צורתה.
                                        קיימות שתי שיטות מרכזיות לביצוע כבישה - חמה או קרה. כבישה החמה, משתמשים בחימום המתכת לטמפרטורות מאוד גבוהה כזאת המאפשרת לחומר דינמיות.
